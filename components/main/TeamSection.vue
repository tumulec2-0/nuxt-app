<template>
    <section class="bg-white dark:bg-gray-900">
        <div
            ...
            <div
                class="grid gap-8 lg:gap-16 grid-cols-4 md:grid-cols-6 justify-items-center">
                ...
                <div class="col-span-2 md:col-span-3 text-center text-gray-500 dark:text-gray-400">
                    <img
                        class="mx-auto mb-4 w-36 h-36 rounded-full"
                ...
                <div class="col-span-4 md:col-span-3 text-center text-gray-500 dark:text-gray-400">
                    <img
                        class="mx-auto mb-4 w-36 h-36 rounded-full"
